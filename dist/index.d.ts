...
export declare const utils: {
    checkCan: <S>(ability: import("@casl/ability").AnyAbility, id: import("@feathersjs/feathers/lib").Id, method: string, modelName: string, service: import("@feathersjs/feathers/lib").Service<S, Partial<S>, import("@feathersjs/feathers/lib").Params<import("@feathersjs/feathers/lib").Query>>, providedOptions?: Partial<import("./types").UtilCheckCanOptions>) => Promise<boolean>;
