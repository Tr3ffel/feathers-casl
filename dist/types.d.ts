...
export declare type Adapter = "feathers-knex" | "feathers-memory" | "feathers-mongodb" | "feathers-mongoose" | "feathers-nedb" | "feathers-objection" | "feathers-sequelize";
...
export declare type CheckBasicPermissionUtilsOptions = Omit<CheckBasicPermissionHookOptions, "notSkippable">;
export declare type CheckBasicPermissionHookOptionsExclusive = Pick<CheckBasicPermissionHookOptions, Exclude<keyof CheckBasicPermissionHookOptions, keyof HookBaseOptions>>;
export declare type AvailableFieldsOption = string[] | ((context: HookContext) => string[]);
...
export declare type AuthorizeHookOptionsExclusive = Pick<AuthorizeHookOptions, Exclude<keyof AuthorizeHookOptions, keyof HookBaseOptions>>;
